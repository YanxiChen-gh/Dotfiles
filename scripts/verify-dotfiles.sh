...
for f in scripts/auth-vanta-agents.py scripts/configure_vanta_snowflake.py scripts/ensure_omp_mcp.py scripts/find-loopback-browser-asset.py scripts/sync_cursor_mcp_from_claude.py scripts/sync_opencode_mcp_from_claude.py agent-rules/build.py herdr/prompt-input.py herdr/remote-opener/open_url.py; do
    if [ -f "$f" ]; then
